...
const ViewAttestationsModal = () => {
    const {viewAttestationsModalOpen, handleViewAttestationsModalClose} = useContext(DigiContext)
  return (
    <Modal
      show={viewAttestationsModalOpen}
      id="viewAttestationsModal"
      size='lg'
      centered
    >
      <Modal.Header>
        <Modal.Title id="viewAttestationsModalLabel">Web Design & Development</Modal.Title>
        <div className="btn-box d-flex gap-3">
          ...
          <button type="button" className="btn btn-sm btn-icon btn-outline-primary" data-bs-dismiss="modal" aria-label="Close" onClick={handleViewAttestationsModalClose}>
...
export default ViewAttestationsModal;

...
const AddNewAttestationsModal = () => {
    const {showAddNewAttestationsModal, handleCloseAddNewAttestationsModal} = useContext(DigiContext)
    const [joiningDate, setJoiningDate] = useState(null);
    const [leaveDate, setLeaveDate] = useState(null);
  return (
    <Modal show={showAddNewAttestationsModal} centered onHide={handleCloseAddNewAttestationsModal} size='lg'>
      <Modal.Header>
        <Modal.Title id="addAttestationsModalLabel">Add New Attestations</Modal.Title>
        <Button variant="outline-primary" size="sm" data-bs-dismiss="modal" aria-label="Close" onClick={handleCloseAddNewAttestationsModal}>
          <i className="fa-light fa-times"></i>
        </Button>
      </Modal.Header>
      <Modal.Body>
        <Form>
          <Form.Group className="mb-3" controlId="addAttestationsName">
            <Form.Label>Name</Form.Label>
            <Form.Control type="text" placeholder="Attestations Name" />
          </Form.Group>
          <Form.Group className="mb-3" controlId="addAttestationsAttachment">
          ...
          <div className="row g-3">
            ...
            <div className="col-12">
              <Form.Label>Attestations Description</Form.Label>
              <CkEditor/>
            </div>
          </div>
        </Form>
      ...
      <Modal.Footer>
        <Button variant="secondary" size="sm" data-bs-dismiss="modal" onClick={handleCloseAddNewAttestationsModal}>
          Close
        </Button>
        <Button variant="primary" size="sm" onClick={handleCloseAddNewAttestationsModal}>
          Save Attestations
        </Button>
      </Modal.Footer>
    </Modal>
...
export default AddNewAttestationsModal;
